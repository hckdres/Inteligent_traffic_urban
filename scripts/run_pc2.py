...
def ejecutar_pc2(pc3_ip: str) -> None:
    ...
    # El socket PULL en servicio_analitica asume connect(), pero si
    # PC1 hace connect(), PC2 debe hacerlo bind(). 
    # Mantenemos las direcciones para PC2.
